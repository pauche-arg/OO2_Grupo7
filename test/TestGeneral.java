...
public class TestGeneral {
	...
	public static void main(String[] args) {
		...
		SistemaTicketABM sistemaAbm = new SistemaTicketABM();
		...
		try {
			...
			System.out.println(ticketAbm.generarTicket("title1", "cuerpo1", usuarioAbm.traer(1)));
			System.out.println(ticketAbm.generarTicket("title2", "cuerpo2", usuarioAbm.traer(1)));
			System.out.println(ticketAbm.generarTicket("title3", "cuerpo3", usuarioAbm.traer(1)));
			System.out.println(ticketAbm.generarTicket("title4", "cuerpo4", usuarioAbm.traer(2)));
			System.out.println(ticketAbm.generarTicket("title5", "cuerpo5", usuarioAbm.traer(2)));
		...
		try {
			...
			sistemaAbm.cambiarEstado(1, "resuelto");
