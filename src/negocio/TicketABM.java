...
public class TicketABM {
	...
	public int agregar(String titulo, String descripcion,Usuario usuarioCreador) throws Exception {
				if (!(validarCampos(titulo, descripcion, "pendiente", usuarioCreador)))  throw new Exception("Error en la validación de datos de Ticket.");
		Ticket c = new Ticket(titulo, descripcion, LocalDate.now(), "pendiente", usuarioCreador, null); //empleadoAsignado puede ser null
	...
	public List<Ticket> traerFiltrado(String estado){
